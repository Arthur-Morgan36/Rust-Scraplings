// todo: Post on github updated code as both changes of the reminder worked perfectly
...
fn hex_to_rgb(hex: String) -> RGB {
    ...
    let working_hex: String = (len_hex.len() < 6)
        .then(|| "0".repeat(6 - &len_hex.len()) + &len_hex)
        .unwrap_or(len_hex);
